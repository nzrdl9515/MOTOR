internal class Program
{
    private static void Main(string[] args)
    {
        ...
        while (true)
        {
            ...
            while (((bidPosOffset == 0 || bidPosOffset == 3) && (HCP(south) < 18 || HCP(north) < 15))
                || ((bidPosOffset == 1 || bidPosOffset == 2) && (HCP(south) < 15 || HCP(north) < 18)))
            {
            ...
            // ** TODO ** allow three consecutive passes before the first bid
            while (passes < 3)
            {
